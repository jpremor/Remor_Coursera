...
/**
 * @file course1.c
 * @brief Hold final course assessment functions
 *
 * @author Jose Remor
 * @date June 26 2021
 *
...
***********************************************************/
/**
 * @brief call a handful of functions and test your function
 * outputs. These include test_data1(), test_data2(), test_memmove1(),
 * test_memmove2(), test_memmove3(), test_memcopy(), test_memset(),
 * and test_reverse().
 *
